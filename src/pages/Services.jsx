            ...
            {packages.map((pkg, index) => (
              ...
              >
                <ServiceCard
                  ...
                  features={pkg.features}
                  popular={pkg.popular}
                  buttonText={pkg.title.split(' ')[0]} // Premium, Standard, Basic
                  buttonColor={
                    pkg.title.includes('Premium') ? 'bg-amber-500 hover:bg-amber-600 text-white' :
                    pkg.title.includes('Standard') ? 'bg-blue-600 hover:bg-blue-700 text-white' :
              ...
              {additionalServices.map((service, index) => (
                ...
                >
                  <div className="p-6 flex flex-col h-full">
                    ...
                    <button
                      className={`mt-auto w-full bg-white bg-opacity-90 hover:bg-opacity-100 py-3 px-4 rounded-xl transition duration-300 font-semibold shadow-md hover:shadow-lg ${
                        index === 0 ? 'text-cyan-700' :
                        index === 1 ? 'text-purple-700' :
                        index === 2 ? 'text-emerald-700' :
                        index === 3 ? 'text-amber-700' :
                        index === 4 ? 'text-fuchsia-700' :
                        'text-violet-700'
                      }`}
                    >
                      Our Services
