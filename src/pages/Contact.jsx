...
//   return (
//     <div className="py-16 bg-gradient-to-br from-slate-900 to-blue-900">
//       <div className="container mx-auto px-4">
//         <div className="text-center mb-12">
//           <h1 className="text-3xl md:text-4xl font-bold text-white py-2 mb-3">Grow Your Online Business With Us!</h1>
//           <div className="relative mx-auto w-20 h-1 overflow-hidden rounded-full">
//             <div className="absolute inset-0 animate-gradientMove bg-gradient-to-r from-blue-500 via-teal-400 to-indigo-500 w-[200%]"/>
//           </div>
//           <p className="text-lg text-blue-100 max-w-2xl mx-auto py-2 mt-4">
...
//                 <div className="mb-4">
//                   <label htmlFor="name" className="block text-slate-700 mb-2 font-medium">Full Name</label>
//                   <input
//                     type="text"
//                     id="name"
//                     name="name"
...
//                   <div>
//                     <label htmlFor="email" className="block text-slate-700 mb-2 font-medium">Email Address</label>
//                     <input
//                       type="email"
//                       id="email"
//                       name="email"
...
//                   </div>
//                   <div>
//                     <label htmlFor="phone" className="block text-slate-700 mb-2 font-medium">Phone Number</label>
//                     <input
//                       type="tel"
//                       id="phone"
//                       name="phone"
...
//                 <div className="mb-4">
//                   <label htmlFor="service" className="block text-slate-700 mb-2 font-medium">Service Interested In</label>
//                   <select
//                     id="service"
//                     name="service"
...
//                 <button 
//                   type="submit" 
//                   className="w-full bg-gradient-to-r from-blue-600 to-indigo-700 hover:from-blue-700 hover:to-indigo-800 text-white font-bold py-3 px-4 rounded-lg transition-all duration-300 transform hover:scale-[1.02] shadow-md"
//                 >
//                   Send Message
//                 </button>
//               </form>
...
//           {/* Contact Info */}
//           <div className="lg:w-1/2">
//             <div className="bg-gradient-to-br from-slate-800 to-slate-900 text-white rounded-xl shadow-xl p-8 h-full border border-slate-700">
//               <h2 className="text-2xl font-bold mb-6">Contact Information</h2>
              
//               <div className="space-y-6 mb-8">
//                 <div className="flex items-start">
//                   <div className="bg-gradient-to-br from-blue-600 to-blue-700 p-3 rounded-xl mr-4">
...
//                     className="bg-slate-700 hover:bg-blue-600 p-3 rounded-xl transition-all duration-300 flex items-center justify-center shadow hover:shadow-md"
//                   >
...
//                     target="_blank"
//                     rel="noopener noreferrer"
//                     className="bg-slate-700 hover:bg-pink-600 p-3 rounded-xl transition-all duration-300 flex items-center justify-center shadow hover:shadow-md"
//                   >
...
//                     target="_blank"
//                     rel="noopener noreferrer"
//                     className="bg-slate-700 hover:bg-blue-400 p-3 rounded-xl transition-all duration-300 flex items-center justify-center shadow hover:shadow-md"
//                   >
...
//                     target="_blank"
//                     rel="noopener noreferrer"
//                     className="bg-slate-700 hover:bg-blue-800 p-3 rounded-xl transition-all duration-300 flex items-center justify-center shadow hover:shadow-md"
//                   >
